  ...
  return (
    <div className="md:container px-10 mx-auto py-5">
      ...
      <div className="flex items-center mt-3 md:mt-4 gap-3">
        <Link
          href={"/movies"}
          className="bg-gray-400 rounded-md py-1 md:py-2 px-2 md:px-4 w-auto text-xs lg:text-lg font-semibold flex flex-row items-center hover:bg-neutral-300 transition mt-2"
        >
          <BackspaceIcon className="w-4 md:w-7 text-slate-950 mr-1" />
          Go Back
        </Link>
      </div>
    </div>
